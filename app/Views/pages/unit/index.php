                ...
                <div class="kt-portlet__head">
                    <div class="kt-portlet__head-label">
                        <h3 class="kt-portlet__head-title">
                            <?= strtoupper(esc($page_judul ?? 'Master Unit Kerja')) ?>
                        </h3>
                    </div>
                                ...
                                <table class="table table-hover table-striped mb-0">
                                    <thead class="thead-light">
                                        <tr>
                                            ...
                                            <th class="text-uppercase text-muted font-weight-bold" style="width: 20%; font-size: 11px; letter-spacing: 0.5px;">Kode Unit</th>
                                            <th class="text-uppercase text-muted font-weight-bold" style="font-size: 11px; letter-spacing: 0.5px;">Nama Unit</th>
                                        ...
                                        <?php if (!empty($datas)): ?>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><span class="font-weight-bold text-primary"><?= esc($row['unitKode']) ?></span></td>
                                                    <td class="font-weight-bold text-dark"><?= esc($row['unitNama']) ?></td>
