    ...
    <div class="kt-portlet__head flex-wrap py-3" style="min-height: 60px;">
        ...
        <div class="kt-portlet__head-toolbar py-1">
            <div class="kt-portlet__head-actions">
                <?php if ($hasData) : ?>
                    <button type="button" id="export" data-name="laporan" class="btn btn-sm btn-outline-success btn-elevate font-weight-bold">
    ...
    <div class="kt-portlet__body p-0">
        <div class="table-responsive">
            <table class="table table-hover table-striped mb-0 no-datatable" id="table_export">
                <caption class="sr-only">Rekapitulasi tiket per bidang untuk periode <?= esc($periodeLabel) ?></caption>
                ...
                <tbody>
                    <?php if ($hasData) : ?>
                        <?php foreach ($datas as $row) : ?>
                            ...
                            ?>
                            <tr>
                                <td class="align-middle font-weight-bold text-dark"><?= esc($row['unitNama'] ?? '-') ?></td>
                    ...
                    <?php else : ?>
                        <tr>
                            <td colspan="6" class="text-center py-5 text-muted">
                                ...
                                Tidak ada tiket pada periode <?= esc($periodeLabel) ?>. Ubah rentang tanggal, lalu tampilkan ulang.
                            </td>
                        </tr>
                    <?php endif; ?>
                </tbody>
                <?php if ($hasData) : ?>
                    <tfoot>
                        <tr class="laporan-total">
                            <td class="align-middle font-weight-bold text-dark">Total</td>
